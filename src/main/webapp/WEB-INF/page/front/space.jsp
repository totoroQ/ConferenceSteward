            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>/</li>
                        <li><a href="space/spaceList" style="text-decoration:underline">特价场地</a></li>
                        <li>/</li>
                        <li class="active">特价场地搜索</li>
                    </ol>

                    <form class="form-inline" style="padding:20px 70px;">
                        <label for="exampleInputName2">场地名称:</label>
                        ...
                        <div class="col-md-4" style="width:350px;padding:10px 30px;">
                            <section class="panel">
                                <div class="pro-img-box">
                                    <img src="${ctx }/upload/${space.spacePicture}" alt="">
                                </div>
                                <div class="panel-body text-center">
                                    <h4 >${space.spaceName}</h4>
                                    <a href="${ctx}/space/detailSpace?spaceId=${space.spaceId}" >查看</a>
                                    <a href="#" >预定</a>
                                    <a href="#" >收藏</a>
                                </div>
                            </section>
