    ...
    <section id="main-content">
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="panel">
                       <form id="detailConference" action="conference/insertCOrder">
	                            ...
	                            <div class="pro-img-box">
	                                ...
	                                <div class="col-md-8">
	                                    <p style="font-size:17px;line-height:2em;">
	                                         会场名称：${conference.conferenceName}<br/>
	           								 会议类型：${conference.typeName}<br/>
	                                         所在城市：${conference.conferenceCity}<br/>
	                                         开会时长：${conference.conferenceDuration}<br/>
	                                         会场库存：${conference.conferenceAmount}<br/>
	                                         参会人数：${conference.conferenceNumber}<br/>
	           								 会场价格：${conference.conferencePrice}<br/>
	                                         特价场地：${conference.conferenceIdentification}<br/>
	                                    </p>
	                                    <button class="btn btn-default" type="" style="float: right;margin: 10px">收藏</button>
