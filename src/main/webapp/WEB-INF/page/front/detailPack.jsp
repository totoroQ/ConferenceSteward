    ...
    <section id="main-content">
        ...
        <section class="wrapper">
            ...
            <ol class="breadcrumb">
                ...
                <li>/</li>
                <li><a href="pack/showPackList" style="text-decoration:underline">会议套餐</a></li>
                <li>/</li>
                <li class="active">会议套餐详情</li>
            </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="panel">
                    	<form id="detailPack" action="pack/insertPackOrder">
                    		<div class="panel-body">
	                            <div class="pro-img-box">
	                                <div class="col-md-4">
	                                   <img src="${pack.packPicture}" alt="" height="200" width="200">
	                                </div>
	                                <div class="col-md-8">
	                                    <p style="font-size:17px;line-height:2em;">
	                                        套餐名称：${pack.packName}<br/>
	                                        所在城市：${pack.packCity}<br/>
	                                        所在地址：${pack.packAddress}<br/>
	                                        容纳人数：${pack.packNumber}<br/>
	                                        套餐价格：${pack.packPrice}<br/>
	                                        适用场地：${pack.packSuitable}<br/>
	                                        套餐库存：${pack.packAmount}<br/>
	                                        优惠措施：${pack.packFavorable}<br/>
	                                    </p>
	                                    <button class="btn btn-default"  style="float: right;margin: 10px">收藏</button>
