                ...
                <div class="col-md-12">
                    ...
                    <form class="form-inline" style="text-align: center">
                        ...
                        <ul style="margin: 130px">
                            <li><label style="font-size: 20px;margin: 40px;letter-spacing:5px;color: blue">提交方案成功！</label></li>
                            <li><label style="margin: 10px">点击查看我的方案：</label></li>
                            <li><a href="${pageContext.request.contextPath}/scheme/selectSchemePageByuser?userId=${u.userId }" style="text-decoration:underline">我的方案</a></li>
                        </ul>
