            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>/</li>
                        <li><a href="tijiaofangan.html" style="text-decoration:underline">会员</a></li>
                        <li>/</li>
                    ...
                    <form class="form-inline" style="text-align: center">
                        ...
                        <ul style="margin: 130px">
                            <li><label style="font-size: 20px;margin: 40px;letter-spacing:5px;color: blue">个人信息修改成功！</label></li>
                            <li><label style="margin: 10px">点击查看个人信息：</label></li>
                            <li><a href="${pageContext.request.contextPath}/user/findById?userId=${u.userId }" style="text-decoration:underline">个人信息</a></li>
                        </ul>
