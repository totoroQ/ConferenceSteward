            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>/</li>
                        <li><a href="huiguanjiaketang.html" style="text-decoration:underline">会议套餐</a></li>
                        <li>/</li>
                        <li class="active">会议套餐搜索</li>
                    </ol>
                        ...
                        <div class="col-md-4" style="width:350px;padding:10px 30px;">
                            <section class="panel">
                                <div class="pro-img-box">
                                    <img src="${ctx}/img/${pack.packPicture}"  alt="" height="200" width="200">
                                </div>
                                <div class="panel-body text-center">
                                    <h4 >${pack.packName}</h4>
                                    <a href="${ctx}/pack/detailPack?packId=${pack.packId}" >查看</a>
                                    <a href="#" >预定</a>
                                    <a href="#" >收藏</a>
                                </div>
                            </section>
