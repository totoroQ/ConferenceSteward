    ...
    <div>
        ...
        <div class="public-content">
            ...
            <div class="public-content-cont">
                <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/conference/editConference"  method="post">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="typeID" name="typeID" value=" ${conference.typeId}">
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="conferencePicture" class=" control-label">会议图片：</label>
                        <div class="col-sm-3">
                            <input type="file" class="form-control" id="conferencePicture" name="conferencePicture" value="${conference.conferencePicture} ">
                        </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="conferenceIdentification" name="conferenceIdentification" value="${conference.conferenceIdentification} ">
                        </div>
                    </div>
