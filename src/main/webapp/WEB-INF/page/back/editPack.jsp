...
<body marginwidth="0" marginheight="0">
    ...
    <div>
        <div class="public-nav">您当前的位置：<a href="index.html">会议套餐</a>&nbsp;&nbsp;&nbsp;修改套餐</div>
        <div class="public-content">
            <div class="public-content-header">
                <h3 >修改套餐</h3>
            </div>
            <div class="public-content-cont">
                <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/pack/editPack"  method="post">
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-3">
                            <input type="file" class="form-control" id="packPicture"  value="${pack.packPicture}" >
                        </div>
                    </div>
                    <div class="form-group ">
