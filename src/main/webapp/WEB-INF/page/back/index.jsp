...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=basePath%>bg-css/public.css">
	...
	<div class="public-header">
		<div class="content">
			...
			<div class="public-header-admin fr">
				<p class="admin-name">会管家管理员${a.adminName } 您好！</p>
...
<div class="public-ifame mt20">
	...
	<!-- 内容模块头 -->
		...
		<div class="public-ifame-leftnav">
			...
			<ul class="left-nav-list">
				...
				<li class="public-ifame-item">
						...
						<div class="ifame-item-sub">
							<ul>
								<li><a href="<%=basePath %>/guide/guideBg" target="content">会议攻略列表</a></li>
							</ul>
						</div>
					</li>
				<li class="public-ifame-item">
					...
					<li class="public-ifame-item">
						...
						<div class="ifame-item-sub">
							<ul>
								<li><a href="<%=basePath %>type/typeList" target="content">类型管理</a></li>
							</ul>
						</div>
					</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="${pageContext.request.contextPath}/scheme/selectSchemePage" target="content">方案管理</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="<%=basePath %>/space/spaceBg" target="content">场地管理</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/user/selectUserPage" target="content">个人信息管理</a></li>
						</ul>
					</div>
				</li>
			</ul>
		...
		<iframe name="content" src="base/main" frameborder="0" id="mainframe" scrolling="yes" marginheight="0" marginwidth="0" width="100%" style="height: 700px;"></iframe>
		</div>
	</div>
</div>
<script src="<%=basePath%>bg-js/jquery.min.js"></script>
<script>
$().ready(function(){
