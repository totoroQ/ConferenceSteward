	...
	<div class="container">
	    ...
	    <div class="public-content">
	        ...
	        <div class="public-content-cont">
	            <form data-toggle="validator" class="form-horizontal" id="spaceForm" name="spaceForm" action="${ctx }/space/add">
	                ...
	                <div class="form-group ">
	                 ...
	                 <div class="form-group ">
	                    ...
	                    <div class="col-sm-3">
	                        <input type="text" class="form-control" id="spaceArea" name="spaceArea">
	                    </div>
	                </div>
	                 <div class="form-group ">
	                    <label for="password" class=" control-label">场地容量：</label>
	                    <div class="col-sm-3">
	                        <input type="text" class="form-control" id="spaceCapacity" name="spaceCapacity">
	                    </div>
	                </div>
	                 <div class="form-group ">
	                    <label for="password" class=" control-label">场地价格：</label>
	                    <div class="col-sm-3">
	                        <input type="text" class="form-control" id="spacePrice" name="spacePrice">
	                    </div>
	                </div>
