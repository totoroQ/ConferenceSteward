                ...
                <ul class="pagination">
                    ...
                    <li>
                    	<c:if test="${requestScope.pagemsg.pageIndex != 1}">
                        	...
                        	<a href="${pageContext.request.contextPath }/scheme/selectSchemePageByValue?pageIndex=1&value=${value}">首页</a>
                    		
                        	<a href="${pageContext.request.contextPath }/scheme/selectSchemePageByValue?pageIndex=${requestScope.pagemsg.pageIndex-1}&value=${value}" aria-label="Previous">
                    ...
                    <li>
                    	...
                    	<c:if test="${requestScope.pagemsg.pageIndex != requestScope.pagemsg.totalPage}">
                        	...
                        	<a href="${pageContext.request.contextPath }/scheme/selectSchemePageByValue?pageIndex=${requestScope.pagemsg.pageIndex+1}&value=${value}" aria-label="Next">
                            	<span>下一页</span>
                        	</a>
                    	
                        	<a href="${pageContext.request.contextPath }/scheme/selectSchemePageByValue?pageIndex=${requestScope.pagemsg.totalPage}&value=${value}">尾页</a>
